...
public class UserInterface
{
    ...
    public static string ShowMessagePokemonCatalog(IReadOnlyList<Pokemon> pokemons)
    {
    ...
    /// <param name="attackingPokemon">El Pokémon que está intentando atacar.</param>
    /// <returns>Un mensaje formateado indicando la efectividad.</returns>
    public static string ShowMessageLowEffectiveness()
    {
        return $"$ El ataque no tiene éxito porque el la precisión del ataque lo impidió";
    }
    ...
    /// </summary>
    public static string ShowMessageMovesInCurrentPlayer(IReadOnlyList<Move> moves, Player player)
    {
        if (player == null)
        {
